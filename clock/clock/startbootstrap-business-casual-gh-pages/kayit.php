                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                ...
                                <span class="section-heading-lower">Kayıt Olun</span>
                            </h2>
                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                <li class="list-unstyled-item list-hours-item d-flex">
                                    <input type="text" name="ad" class="form-control mb-1" placeholder="Adınız...">
                                </li>
                                <li class="list-unstyled-item list-hours-item d-flex">
                                    <input type="text" name="soyad" class="form-control mb-1" placeholder="Soyadınız...">
                                </li>
                                <li class="list-unstyled-item list-hours-item d-flex">
                                ...
                                <li class="list-unstyled-item list-hours-item d-flex">
                                    ...
                                    <span class="ms-auto"><input type="submit" name = "kaydet" class="btn btn-warning  form-control mb-5" value = "Kayıt Ol"></span>
                                </li>
