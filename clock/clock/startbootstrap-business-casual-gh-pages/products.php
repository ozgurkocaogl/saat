                    ...
                    <div class="product-item-title d-flex">
                        <div class="bg-faded p-5 d-flex ms-auto rounded">
                            <h2 class="section-heading mb-0">
                                ...
                                <span class="section-heading-lower">Your Clock</span>
                            </h2>
                        </div>
                    </div>
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="assets/img/saat1.jpg" alt="..." />
                    <div class="product-item-description d-flex me-auto">
                        <div class="bg-faded p-5 rounded"><p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras viverra nulla ac purus tempor tristique. Proin luctus lacus eleifend convallis ultricies. Aenean gravida metus enim, sed pretium odio euismod nec. Mauris semper efficitur maximus. Donec pharetra vitae arcu quis euismod.</p></div>
                    </div>
                </div>
            </div>
        </section>
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="assets/img/saat2.jpg" alt="..." />
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="assets/img/saat3.jpg" alt="..." />
                    <div class="product-item-description d-flex me-auto">
                        <div class="bg-faded p-5 rounded"><p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras viverra nulla ac purus tempor tristique. Proin luctus lacus eleifend convallis ultricies. Aenean gravida metus enim, sed pretium odio euismod nec. Mauris semper efficitur maximus. Donec pharetra vitae arcu quis euismod.</p></div>
                    </div>
                </div>
