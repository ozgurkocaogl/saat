                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                ...
                                <span class="section-heading-lower">Yönetici Paneli giriş</span>
                            </h2>
                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                ...
                                <span class="ms-auto"><input type="submit" name = "giris" class="btn btn-warning  form-control mb-5" value = "Admin Giriş Yap"></span>
                                </li>
